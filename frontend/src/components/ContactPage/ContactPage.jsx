...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/7710935875?text=${whatsappMessage}`, '_blank');
  };
                ...
                <div className={contactStyles.contactInfo}>
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>+91 1122000012</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>bookings@bms.com</p>
                      <p className={contactStyles.contactDetail}>support@bms.com</p>
                    </div>
                  </div>
